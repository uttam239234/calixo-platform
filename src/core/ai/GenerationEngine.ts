...
*Generated using ${brandName}'s AI Content Studio with enterprise-grade AI*`,
    ...
    "whatsapp-campaign": `Hi! 👋 ${getEmailHook()} with ${brandName}.\n\n${getRandomStat()} of ${audienceName} teams like yours are already seeing results.\n\nWant to see how? Reply YES and we'll send you a quick 2-minute overview. 🚀\n\nReply STOP to opt out anytime.`,

    "sms": `${brandName}: ${getRandomStat()} better results for ${audienceName}. See how → [link]. Reply STOP to opt out.`,

    "brochure-copy": `${brandName}\n\n${getBlogTitle(brandName)}\n\nFront panel\n— Bold headline: "${getRandomStat()} more content, ${getRandomStat()} less effort"\n— Hero visual placeholder\n\nInside panels\n— Who we help: ${audienceName}\n— What you get: AI-powered insights, real-time analytics, personalisation at scale, ${getRandomStat()} faster publishing\n— Proof point: "${brandName} transformed how we create content." — Enterprise Customer, ${getCompanyName()}\n\nBack panel\n— Contact details and CTA: ${getEmailHook()}\n— Website / QR code placeholder`,

    "case-study": `# How ${getCompanyName()} Achieved ${getRandomStat()} Growth with ${brandName}\n\n**Industry:** ${audienceName}\n\n## The Challenge\n\nBefore ${brandName}, the team struggled with inconsistent content output and slow production cycles.\n\n## The Solution\n\nBy adopting ${brandName}'s AI-powered content platform, the team was able to standardise brand voice while scaling output across every channel.\n\n## The Results\n\n- ${getRandomStat()} increase in content engagement\n- ${getRandomStat()} reduction in production time\n- ${getRandomStat()} improvement in conversion rates\n\n## In Their Words\n\n*"${brandName} transformed how we create content. Our team ships 3x more content with better results."*\n— Enterprise Customer, ${getCompanyName()}`,
  };
