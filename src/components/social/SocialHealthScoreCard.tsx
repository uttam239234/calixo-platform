...
export function SocialHealthScoreCard() {
  const { healthScore } = useSocial();
  ...
  return (
    <Card className="p-5" hover={false}>
      <div>
        <p className="text-xs font-semibold uppercase tracking-wider text-primary">Social Health Score</p>
        <p className="mt-1 text-xs text-muted-foreground">Publishing, queue, approvals, growth, and engagement</p>
      </div>
